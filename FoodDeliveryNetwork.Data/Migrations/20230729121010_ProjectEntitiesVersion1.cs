...
{
    /// <inheritdoc />
    public partial class ProjectEntitiesVersion1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourierToRestaurant", x => new { x.CourierId, x.RestaurantId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispatcherToRestaurant", x => new { x.DispatcherId, x.RestaurantId });
                    table.ForeignKey(
